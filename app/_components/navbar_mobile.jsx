...
export const Navbar = () => {
  ...
  return (
    <nav className="flex content-center items-center justify-between fixed bottom-0 w-full shrink-0 h-20 bg-fernGreen text-timberwolf" style={{ padding: "0px 60px" }}>
