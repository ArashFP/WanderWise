    ...
    <main className="w-full min-h-screen flex flex-col" style={{ background: 'url(https://images.pexels.com/photos/2033933/pexels-photo-2033933.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1) no-repeat center center', backgroundSize: 'cover' }}>
      ...
      <div className="w-2/3 mx-auto pt-16 grid grid-cols-2 grid-rows-[1fr,1fr,auto] gap-4">
        ...
        <div className="col-span-2 mx-auto justify-center items-center inline-flex">
          <CircleCheck className="w-full h-2/3 text-timberwolf fill-red-600" />
        </div>
        <div className="text-center col-span-2 bg-gray-500 rounded-lg border-2 border-white">
          <p className="p-5">payment failed</p>
          <p className="pb-5 px-5">Unfortunately, your payment was not successful. This listing is probably already booked for the duration of your wanted stay.</p>
        </div>
      </div>
...
// <img
// className="absolute right-16 top-24 w-2/3"
// src="/Font_logo_Ljus.png"
// alt="Logo"
// />
...
// <hr />
// <p>
//   Unfortunately, your payment was not successful. This listing is
//   probably already booked for the duration of your wanted stay.
// </p>
// </div>
// <Navbar />
// <Footer />
